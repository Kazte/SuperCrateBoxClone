...
namespace Game
{
    ...
    public class Engine
    {
        ...
        public static void Draw(string texture, Vector2D position, float scaX = 1, float scaY = 1, float angle = 0, float offsetX = 0, float offsetY = 0)
        {
            Draw(GetTexture(texture), position.X, position.Y, scaX, scaY, angle, offsetX, offsetY);
        }
